...
export default function FootballDemoPage() {
  ...
  const { data: searchResults, loading: searchLoading, error: searchError } = useFootballTeamSearch(searchQuery);
                  ...
                  <Card>
                    ...
                    <CardContent>
                      {standingsLoading ? (
                        ...
                        <div className="space-y-2">
                          {standings?.standings?.[0]?.table?.slice(0, 10).map((team: any, index: number) => (
                    ...
                    <div key={team.id} className="flex items-center justify-between p-3 border rounded">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{team.area?.name}</div>
                        </div>
                      </div>
                      <Button 
                        variant="outline" 
